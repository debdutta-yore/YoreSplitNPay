...
infix fun String.gt(value: Any): Kontakts.Expression {
    return Kontakts.Expression(this, Kontakts.Expression.Operator.Gt, value)
}
infix fun String.lt(value: Any): Kontakts.Expression {
    return Kontakts.Expression(this, Kontakts.Expression.Operator.Lt, value)
}
infix fun String.gte(value: Any): Kontakts.Expression {
    return Kontakts.Expression(this, Kontakts.Expression.Operator.Gte, value)
}
infix fun String.lte(value: Any): Kontakts.Expression {
    return Kontakts.Expression(this, Kontakts.Expression.Operator.Lte, value)
}
